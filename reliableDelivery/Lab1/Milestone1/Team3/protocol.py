        ...
        for packet in self.deserializer.nextPackets():
            ...
            if packet.status == HandshakePacket.SUCCESS:
                if self._mode == "client":
                    if packet.SYN == self.SYN + 1 and packet.ACK == 0 and isinstance(packet.error, playground.common.CustomConstant):
                    ...
                    if packet.ACK == 1 and isinstance(packet.error, playground.common.CustomConstant):
                        self.handshakeComplete = True
                ...
                if (isinstance(packet.ACK, playground.common.CustomConstant) or packet.ACK == 0) and isinstance(packet.error, playground.common.CustomConstant):
