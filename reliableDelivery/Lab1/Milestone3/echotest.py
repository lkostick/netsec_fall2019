...
class EchoServerProtocol(asyncio.Protocol):
    ...
    def data_received(self, data):
        # print('server: something received: ' + str(data))
...
class EchoClientProtocol(asyncio.Protocol):
    ...
    def data_received(self, data):
        # print('client: something received: ' + str(data))
        self.deserializer.update(data)
        for echoPacket in self.deserializer.nextPackets():
            # print('client: packet received: ' + str(data))
...
if __name__ == "__main__":
    ...
    if mode.lower() == "server":
        coro = playground.create_server(lambda: EchoServerProtocol(), port=port, family=stack)
